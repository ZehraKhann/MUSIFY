                    ...
                    ?>
                            ...
                            <?php while($row = mysqli_fetch_assoc($result)){ ?>               
                                <tr>
                                    ...
                                    <td><a class="btn btn-sm btn-primary" href='edit_album.php?id=<?php echo $row['album_id'] ?>'>Edit</a> &nbsp;&nbsp;&nbsp;
                                    <a class="btn btn-sm btn-primary" href='delete_album.php?id=<?php echo $row['album_id'] ?>'>Delete</a></td>
