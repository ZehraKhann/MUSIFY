			...
			<header>
				...
				<nav class="secondary-menu">
					<div class="container">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Welcome</strong>:&nbsp; <a href="#" style="font-size:2.4rem; color:darkorange; font-weight:bolder;">&nbsp;<?php echo $_SESSION ['myname']; ?></a><a href="#">&nbsp;&nbsp;&nbsp;&nbsp;<img style="height: 3rem; border-radius: 25px; margin-top: -5px;" src="../Musify/img/user/<?php echo $_SESSION ['theimg']; ?>" alt=""></a>
